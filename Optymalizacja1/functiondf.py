...
Fbin = 10 #*c l/s szybkość wplywania wody do zbiornika B

Db = 36.5665 #cm^2 prędkość wylewania sie wody z zbiornika B

a = 0.98 #wspolczynnik odpowiadajacy za lepkosc cieczy
b = 0.63 #wsp odpowiadajacy za zwężenie strumienia cieczy
g = 9.81 # przyspieszenie ziemskie

#Da - pole przekroju otworu przez które leje sie woda z zbiornika A do B
